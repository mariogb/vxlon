...
public class ComercialDocumentTypeInService extends AbstractServiceLon<ComercialDocumentTypeIn>{
    ...
    public ComercialDocumentTypeInService() {
        init0();
    }
...
//pkey
    doFieldSort("pkey","pkey","comercial_document_type_in");               
...
//afectStock
    doFieldSort("afectStock","afect_stock","comercial_document_type_in");               
...
//pname
    doFieldSort("pname","pname","comercial_document_type_in");               
...
/** OTM 2  ON MODEL**/
    ...
    if(withIds){
        m.put("comercialDocumentTypeIn_id",LONG);
    }        
//pkey    
    m.put("comercialDocumentTypeIn_pkey",STRING);              
//afectStock    
    m.put("comercialDocumentTypeIn_afectStock",STRING);              
//pname    
    m.put("comercialDocumentTypeIn_pname",STRING);          
    ...
    if(withIds){
        lToCell(r, row,"comercial_document_type_in_id", nc++); 
            ...
            sToCell(r, row,"comercial_document_type_in_pkey", nc++);     //afectStock       
            sToCell(r, row,"comercial_document_type_in_afect_stock", nc++);     //pname       
