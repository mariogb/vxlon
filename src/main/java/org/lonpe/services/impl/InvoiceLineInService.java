...
//pkey
    doFieldSort("pkey","pkey","invoice_line_in");               
...
//askQuantity
    doFieldSort("askQuantity","ask_quantity","invoice_line_in");               
...
//createdDate
    doFieldSort("createdDate","created_date","invoice_line_in");               
...
//descount
    doFieldSort("descount","descount","invoice_line_in");               
...
//invoiceDate
    doFieldSort("invoiceDate","invoice_date","invoice_line_in");               
...
//orden
    doFieldSort("orden","orden","invoice_line_in");               
...
//status
    doField("status","status","invoice_line_in");               
...
//supplyDate
    doFieldSort("supplyDate","supply_date","invoice_line_in");               
...
//supplyQuantity
    doFieldSort("supplyQuantity","supply_quantity","invoice_line_in");               
...
//taxPorcent
    doFieldSort("taxPorcent","tax_porcent","invoice_line_in");               
...
//total
    doFieldSort("total","total","invoice_line_in");               
...
//totalCost
    doFieldSort("totalCost","total_cost","invoice_line_in");               
...
//unitCost
    doFieldSort("unitCost","unit_cost","invoice_line_in");               
...
//(1)  comercialDocument
    doFieldMT0("invoice_line_in","comercialDocument", "comercial_document");  
    ...
    final ZtatUnitInfoLon zComercialDocument = new ZtatUnitInfoLon("comercial_document_id", "comercialDocument",  "comercial_document_out","pname","comercial_document");
    mz1.put("zComercialDocument", zComercialDocument);    

//(1)  product
    doFieldMT0("invoice_line_in","product", "product");  
...
//(1)  stockRackProduct
    doFieldMT0("invoice_line_in","stockRackProduct", "stock_rack_product");  
...
//(2)  contract   contract  
    ...
    final JsonObject contractFromComercialDocument =   doMto2("contract","contractOut","comercialDocument");        
    ...
    final ZtatUnitInfoLon2 zContractFromComercialDocument = new ZtatUnitInfoLon2(zComercialDocument, "contract_id", "contract",  "contract_out","pname","contract");
...
//(2)  comercialDocumentType   comercialDocumentType  
    ...
    final JsonObject comercialDocumentTypeFromComercialDocument =   doMto2("comercialDocumentType","comercialDocumentTypeOut","comercialDocument");        
    ...
    final ZtatUnitInfoLon2 zComercialDocumentTypeFromComercialDocument = new ZtatUnitInfoLon2(zComercialDocument, "comercial_document_type_id", "comercialDocumentType",  "comercial_document_type_out","pname","comercial_document_type");
...
//(3)   departamentBaseTimePeriod   
    ...
    final JsonObject departamentBaseTimePeriodFromContractFromComercialDocument =   doMto2("departamentBaseTimePeriod","departamentBaseTimePeriod","contract");        
         
    mto3.add(departamentBaseTimePeriodFromContractFromComercialDocument);        

     
    final ZtatUnitInfoLon3 zDepartamentBaseTimePeriodFromContractFromComercialDocument = new ZtatUnitInfoLon3(zContractFromComercialDocument, "departament_base_time_period_id", "departamentBaseTimePeriod",  "departament_base_time_period","null","departament_base_time_period");
    mz3.put("zDepartamentBaseTimePeriodFromContractFromComercialDocument",zDepartamentBaseTimePeriodFromContractFromComercialDocument);    
...
//(3)   workSpace   
    ...
    if(withIds){
        m.put("invoiceLineIn_id",LONG);
    }        
//pkey    
    m.put("invoiceLineIn_pkey",STRING);              
//askQuantity    
    m.put("invoiceLineIn_askQuantity",BIGDECIMAL);              
//createdDate    
    m.put("invoiceLineIn_createdDate",LOCALDATETIME);              
//descount    
    m.put("invoiceLineIn_descount",BIGDECIMAL);              
//invoiceDate    
    m.put("invoiceLineIn_invoiceDate",LOCALDATETIME);              
//orden    
    m.put("invoiceLineIn_orden",INTEGER);              
//status    
    m.put("invoiceLineIn_status",STRING);              
//supplyDate    
    m.put("invoiceLineIn_supplyDate",LOCALDATETIME);              
//supplyQuantity    
    m.put("invoiceLineIn_supplyQuantity",BIGDECIMAL);              
//taxPorcent    
    m.put("invoiceLineIn_taxPorcent",BIGDECIMAL);              
//total    
    m.put("invoiceLineIn_total",BIGDECIMAL);              
//totalCost    
    m.put("invoiceLineIn_totalCost",BIGDECIMAL);              
//unitCost    
    m.put("invoiceLineIn_unitCost",BIGDECIMAL);          
    if(level<1){
        return m;    
    }       
...
//[3] workSpace --   workSpace
    ...
    if(withIds){
        lToCell(r, row,"invoice_line_in_id", nc++); 
            ...
            sToCell(r, row,"invoice_line_in_pkey", nc++);     //askQuantity     
            bdToCell(r, row,"invoice_line_in_ask_quantity", nc++);     //createdDate            
            ldtToCell(r, row,"invoice_line_in_created_date", nc++);     //descount     
            bdToCell(r, row,"invoice_line_in_descount", nc++);     //invoiceDate            
            ldtToCell(r, row,"invoice_line_in_invoice_date", nc++);     //orden            
            ldToCell(r, row,"invoice_line_in_orden", nc++);     //status       
            sToCell(r, row,"invoice_line_in_status", nc++);     //supplyDate            
            ldtToCell(r, row,"invoice_line_in_supply_date", nc++);     //supplyQuantity     
            bdToCell(r, row,"invoice_line_in_supply_quantity", nc++);     //taxPorcent     
            bdToCell(r, row,"invoice_line_in_tax_porcent", nc++);     //total     
            bdToCell(r, row,"invoice_line_in_total", nc++);     //totalCost     
            bdToCell(r, row,"invoice_line_in_total_cost", nc++);     //unitCost     
...
//level 3    
        sz0.applyG3(mz3.get("zDepartamentBaseTimePeriodFromContractFromComercialDocument"));               
