...
//descount
    names.add("descount");
    insertMapFields.put("invoice_line_out.descount","descount");  

//Create property descount       
    final JsonObject descount = ps00a("descount", "BigDecimal",true);

    sortMapFields.put("descount", "invoice_line_out_descount");               
 
    ps.add(descount);
 
//invoiceDate
    names.add("invoiceDate");
    insertMapFields.put("invoice_line_out.invoice_date","invoiceDate");  

//Create property invoiceDate       
    final JsonObject invoiceDate = ps00a("invoiceDate", "LocalDateTime",false);

    sortMapFields.put("invoiceDate", "invoice_line_out_invoice_date");               
...
//total
    names.add("total");
    insertMapFields.put("invoice_line_out.total","total");  

//Create property total       
    final JsonObject total = ps00a("total", "BigDecimal",true);

    sortMapFields.put("total", "invoice_line_out_total");               
 
    ps.add(total);
 
//totalCost
    names.add("totalCost");
    insertMapFields.put("invoice_line_out.total_cost","totalCost");  

//Create property totalCost       
    final JsonObject totalCost = ps00a("totalCost", "BigDecimal",true);

    sortMapFields.put("totalCost", "invoice_line_out_total_cost");               
 
    ps.add(totalCost);
 
//unitCost
    names.add("unitCost");
    insertMapFields.put("invoice_line_out.unit_cost","unitCost");  

//Create property unitCost       
    final JsonObject unitCost = ps00a("unitCost", "BigDecimal",true);

    sortMapFields.put("unitCost", "invoice_line_out_unit_cost");               
...
//(1)  comercialDocument --------------------
    ...
    insertMapFields.put("invoice_line_out.comercial_document_id","comercialDocument_id");    
...
//(2)   contract 
    ...
    final JsonObject contract =   doMto2("contract","contractIn","comercialDocument");        
...
//(2)   comercialDocumentType 
    ...
    final JsonObject comercialDocumentType =   doMto2("comercialDocumentType","comercialDocumentTypeIn","comercialDocument");        
...
//1  comercial_document  -- comercial_document_id
    zComercialDocument = new ZtatUnitInfoLon("comercial_document_id", "comercialDocument",  "comercial_document_in","pname","comercial_document");
...
//3
 ...
 asMaybeNullLocalDate(r,"invoice_line_out_supply_date",jsa); //true
    ...
    if(withIds){
                m_.put("invoiceLineOut_id","Long");
            }
            
    //pkey       
            m_.put("invoiceLineOut_pkey","String"); 
            
    //askQuantity       
            m_.put("invoiceLineOut_askQuantity","BigDecimal"); 
            
    //createdDate       
            m_.put("invoiceLineOut_createdDate","LocalDateTime"); 
            
    //descount       
            m_.put("invoiceLineOut_descount","BigDecimal"); 
            
    //invoiceDate       
            m_.put("invoiceLineOut_invoiceDate","LocalDateTime"); 
            
    //orden       
            m_.put("invoiceLineOut_orden","Integer"); 
            
    //status       
            m_.put("invoiceLineOut_status","String"); 
            
    //supplyDate       
            m_.put("invoiceLineOut_supplyDate","LocalDateTime"); 
            
    //supplyQuantity       
            m_.put("invoiceLineOut_supplyQuantity","BigDecimal"); 
            
    //taxPorcent       
            m_.put("invoiceLineOut_taxPorcent","BigDecimal"); 
            
    //total       
            m_.put("invoiceLineOut_total","BigDecimal"); 
            
    //totalCost       
            m_.put("invoiceLineOut_totalCost","BigDecimal"); 
            
    //unitCost       
            m_.put("invoiceLineOut_unitCost","BigDecimal"); 
...
//[3] workSpace  
    ...
    //pkey       
            sToCell(r, row,"invoice_line_out_pkey", nc++); 
    //askQuantity     
            bdToCell(r, row,"invoice_line_out_ask_quantity", nc++); 
    //createdDate            
            ldtToCell(r, row,"invoice_line_out_created_date", nc++); 
    //descount     
            bdToCell(r, row,"invoice_line_out_descount", nc++); 
    //invoiceDate            
            ldtToCell(r, row,"invoice_line_out_invoice_date", nc++); 
    //orden            
            ldToCell(r, row,"invoice_line_out_orden", nc++); 
    //status       
            sToCell(r, row,"invoice_line_out_status", nc++); 
    //supplyDate            
            ldtToCell(r, row,"invoice_line_out_supply_date", nc++); 
    //supplyQuantity     
            bdToCell(r, row,"invoice_line_out_supply_quantity", nc++); 
    //taxPorcent     
            bdToCell(r, row,"invoice_line_out_tax_porcent", nc++); 
    //total     
            bdToCell(r, row,"invoice_line_out_total", nc++); 
    //totalCost     
            bdToCell(r, row,"invoice_line_out_total_cost", nc++); 
    //unitCost     
...
//level 1
    ...
    //level 3
        ...
        sz0.applyG3(zComercialDocument,zContract,zProgramBaseTimePeriod);               
